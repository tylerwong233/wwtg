...
public class ExcelReportBuilder extends AbstractExcelReportBuilder {
	...
	private void buildGridExcelHeader(Sheet sheet, Map<Integer, Object> rowMap, int maxHeaderLevel, int currentLevel, int startHeaderRow, int startHeaderCol, List<ReportGridHeader> topHeaders, Map<String, CellStyle> styles) {
