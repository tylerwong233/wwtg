...
public class MyDateUtil {
	...
	public static List<String> getDateBetweenStartEndStringList(Date startDate, Date endDate) {
		...
		dayc1.set(Calendar.SECOND, 0);
		dayc1.set(Calendar.MILLISECOND, 0);
		dayc2.setTime(endDate);
		dayc2.set(Calendar.SECOND, 0);
		dayc2.set(Calendar.MILLISECOND, 0);
		List<String> dateBetweenStartEndStringList = new ArrayList<>();
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		while (dayc1.compareTo(dayc2) <= 0) {
			dateBetweenStartEndStringList.add(sdf.format(dayc1.getTime()));
