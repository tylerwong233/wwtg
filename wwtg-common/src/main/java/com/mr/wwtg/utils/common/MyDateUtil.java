...
public class MyDateUtil {
	...
	/**
	 * 获取与参数date相比,N天前的Date
	 * 
	 */
	public static Date findDaysBefore(Date date, int day) {
		Calendar cal = Calendar.getInstance(); // 当前时间
		cal.setTime(date);
		cal.add(Calendar.DATE, -day); // - :前xxx天; +:后xxx天
	 ...
	 * @return 格式后的日期 yyyy-MM-dd HH:mm:ss
	 */
	public static String parserToSecond(long millis) {
		Date date = new Date();
		date.setTime(millis);
	 ...
	 * @return 格式后的日期 yyyy-MM-dd HH:mm:ss
	 */
	public static Date parserToSecondDate(long millis) {
		Date date = new Date();
		date.setTime(millis); 
		try {
			return date;
	 ...
	 * @return 格式后的日期 yyyy-MM-dd HH:mm:ss
	 */
	public static String parserToDay(long millis) {
		Date date = new Date();
		date.setTime(millis);
	 ...
	 * @return 格式后的日期 yyyy-MM-dd
	 */
	public static Date parseToDay(String strDate) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		try {
			return sdf.parse(strDate);
		} catch (Exception e) {
	 ...
	 * @return 格式后的日期 yyyy-MM-dd
	 */
	public static Date parseToDay2(String strDate) {
	 ...
	 * @return 格式后的日期 yyyy-MM-dd
	 */
	public static Date parseToDay3(String strDate) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
		try {
			return sdf.parse(strDate);
		} catch (Exception e) {
	...
	public static Date getCurBeginCycleDate(Date currentDate) {
		...
		return MyDateUtil.parserToSecond(dateStr);
	}
	...
	/**
	 * 取得当前日期的最前一秒 yyyy-MM-dd 00:00:01
	 * 
	 * @param currentDate
	 * @return
	 */
	public static Date getCurrStart000001(Date currentDate) {
	...
	public static Date getCurEndCycleDate(Date currentDate) {
		...
		calendar.setTime(MyDateUtil.parserToSecond(dateStr));
	 ...
	 * @return
	 */
	public static void getDateBetweenStartEndStringList(final String start_date, final String end_date) {
		try {
			...
			for (; dayc1.compareTo(dayc2) <= 0;) { // dayc1在dayc2之前就循环
				System.out.println(dayc1.get(Calendar.YEAR) + "年" + dayc1.get(Calendar.MONTH) + "月"
						+ dayc1.get(Calendar.DATE) + "日"); // 打印年月日
	 ...
	 * @return
	 */
	public static List<String> getDateBetweenStartEndStringList(Date startDate, Date endDate) {
		Calendar dayc1 = new GregorianCalendar();
		Calendar dayc2 = new GregorianCalendar();
		dayc1.setTime(startDate);
		dayc2.setTime(endDate);
		List<String> dateBetweenStartEndStringList = new ArrayList<String>();
		for (; dayc1.compareTo(dayc2) <= 0;) { // dayc1在dayc2之前就循环
			String result = dayc1.get(Calendar.YEAR) + "年" + dayc1.get(Calendar.MONTH) + "月" + dayc1.get(Calendar.DATE)
					+ "日";
			System.out.println(result); // 打印年月日
			dateBetweenStartEndStringList.add(result);
			dayc1.add(Calendar.DAY_OF_YEAR, 1); // 加1天
		}
		return dateBetweenStartEndStringList;
	}
	...
	public static void main123(String[] args) {
		Date d1 = new Date(2014, 7, 30);
		Date d2 = new Date(2014, 7, 1);
		System.out.println(isSameMonthBetweenDate(d1, d2));
	 ...
	 * @return
	 */
	public static boolean isSameMonthBetweenDate(Date startDate, Date endDate) {
	 ...
	 */
	public static String formatToMillisecondNum(Date date) {
		try {
	 ...
	 * @return HH
	 */
	public static String formatToOnlyHour(Date date) {
		try {
	 ...
	 * @return yyyyMMdd
	 */
	public static String formatToDayOnlyNum(Date date) {
		try {
			SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
			String s = sdf.format(date);
			return s;
	...
	public static String getWeek(String sdate) {
		// 再转换为时间
		Date date = MyDateUtil.strToDate(sdate);
	...
	// 获得指定日期前N天
	public static Date getBeforeDay(Date date, Integer duration) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.roll(Calendar.DATE, -duration);// 日期回滚N天，也就是当前日期前N天
		return cal.getTime();
	}

	// 获得指定日期后N天
	public static Date getNextDay(Date date, Integer duration) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(Calendar.DATE, duration);// 日期增加N天，也就是当前日期后N天
		return cal.getTime();
	}

	// 获得指定日期前N秒
	public static Date getBeforeSecond(Date date, Integer duration) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.roll(Calendar.SECOND, -duration);// 日期回滚N秒，也就是当前日期前N秒
		return cal.getTime();
	}
	...
	public static void main(String[] args) {
		...
		Date billEndDate = calendar.getTime();
	...
	public static void main22(String[] args) {
		 ...
		 * Calendar.getInstance(); cal1.set(2006, 11, 13, 10, 10); cal2.set(2006, 6, 18,
		 * 10, 30); //
		 * System.out.println(DateUtil.getMonthsBetweenDate(cal1,cal2,false));
		 * System.out.println(DateUtil.parser(cal1.getTime()));
		 * /*System.out.println(DateUtil.getDateField(new Date(), Calendar.YEAR));
		 * System.out.println(DateUtil.getDateField(new Date(), Calendar.DATE));
		 * System.out.println(DateUtil.getDateField(new Date(), Calendar.MONTH));
		 */
	...
	public static void main213(String[] args) throws ParseException {
		Date startDateTime = MyDateUtil.parserToSecond("2013-05-13 14:02:42");
		Date endDateTime = MyDateUtil.parserToSecond("2014-06-17 12:02:42");
		String startHHmmStr = MyDateUtil.formatToHHmm(startDateTime);
		String startDayStr = MyDateUtil.formatToDay(startDateTime);
		String endHHmmStr = MyDateUtil.formatToHHmm(endDateTime);
		String endDayStr = MyDateUtil.formatToDay(endDateTime);
		// 得到二个日期间的间隔天数
		long day = (endDateTime.getTime() - startDateTime.getTime()) / (24 * 60 * 60 * 1000);
		// 开始那天
		String tStart = startDayStr + "==" + startHHmmStr + "-"
				+ MyDateUtil.formatToHHmm(MyDateUtil.getCurrEnd(startDateTime));
		...
		for (int i = 0; i < day; i++) {
			...
			String tMiddle = MyDateUtil.formatToDay(date) + "=="
					+ MyDateUtil.formatToHHmm(MyDateUtil.getCurrStart(date)) + "-"
					+ MyDateUtil.formatToHHmm(MyDateUtil.getCurrEnd(date));
			System.out.println(i + 1 + "--" + tMiddle);
		}

		// 结束那天
		String tEnd = endDayStr + "==" + MyDateUtil.formatToHHmm(MyDateUtil.getCurrStart(endDateTime)) + "-"
				+ endHHmmStr;
		System.out.println(tEnd);

	}

	public static Date getAfterDateBySecond(Date date, int second) {
		Calendar cd = Calendar.getInstance();
		cd.setTime(date);
		cd.add(Calendar.SECOND, second);// 加秒
		return cd.getTime();

	}

	// workYear 年以上工作经验 参数:参加工作时间
	public static String getWorkYear(String workYear) {
		try {
			Calendar calendar = Calendar.getInstance();
			String year = "" + calendar.get(Calendar.YEAR);
			Integer nowI = Integer.valueOf(year);
			Integer workYearI = Integer.valueOf(workYear);
			Integer result = nowI - workYearI;
	 ...
	 * 取得永久时间
	 */
	public static Date getWorldEnd() {
			Calendar calendar = Calendar.getInstance();
