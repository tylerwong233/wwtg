...
public final class MyFileUtil {
	...
	public static List<File> getFilesSearched(String root, String fileName) {
		File rootFile = new File(root);
		SuffixFileFilter fileSuffixFileFilter = new SuffixFileFilter(fileName, IOCase.INSENSITIVE);
		IOFileFilter dirSuffixFileFilter = CanReadFileFilter.CAN_READ;
		List<File> files = (List<File>) FileUtils.listFiles(rootFile, fileSuffixFileFilter, dirSuffixFileFilter);
		return files;
